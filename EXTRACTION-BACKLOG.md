...
| **5 — NEXT** | Protocol docs → canon | `docs/{SUCCESS-FAILURE-CONTRACT,INCIDENT-RESPONSE-PROTOCOL,RESIDUALITY-CONTRACTS,COMMIT-PROTOCOL,AGENT-PROTOCOL}.md` | partial (constitution/doctrine) | promote battle-tested protocols into canon |
